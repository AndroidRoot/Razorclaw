...
my $ALIB = "$DROID/prebuilt/ndk/android-ndk-r4/platforms/android-5/arch-arm/usr/lib";
my $PREBUILT="$DROID/prebuilt/linux-x86";
my $TOOLCHAIN = "$PREBUILT/toolchain/arm-eabi-4.4.0/";
my $INTERWORK = "$PREBUILT/arm-eabi-4.4.0/";
my $LDSCRIPTS = "$TOOLCHAIN/arm-eabi/lib/ldscripts/";
...
print "\n\n\n";
my @include_paths = (
    "-I$DROID/prebuilt/ndk/android-ndk-r4/platforms/android-5/arch-arm/usr/include/",
